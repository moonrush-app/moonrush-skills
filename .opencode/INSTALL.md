...
OpenCode discovers skills natively. Clone, symlink, configure.
...
1. **Clone:**
   ...
   ```bash
   git clone https://github.com/moonrush/moonrush-skills ~/.opencode/moonrush-cli
   ```
...
3. **Register the plugin:**
   ...
   ln -s ~/.opencode/moonrush-cli ~/.opencode/plugins/moonrush-cli
   ```

4. **Symlink the skills:**
...
6. **Restart OpenCode** so it picks up the skills.
...
rm ~/.opencode/plugins/moonrush-cli
